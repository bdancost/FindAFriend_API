...
describe('Search Pets (E2E)', () => {
  ...
  it('should be able to search pets by city', async () => {
    ...
    const response = await request(app.server).get('/orgs/pets').query({ city: org.city })
  ...
  it('should be able to search pets by city and age', async () => {
    ...
    const response = await request(app.server).get('/orgs/pets').query({ city: org.city, age: '1' })
  ...
  it('should be able to search pets by city and size', async () => {
    ...
    const response = await request(app.server).get('/orgs/pets').query({ city: org.city, size: 'small' })
  ...
  it('should be able to search pets by city and energy level', async () => {
    ...
    const response = await request(app.server).get('/orgs/pets').query({ city: org.city, energy_level: 'low' })
  ...
  it('should be able to search pets by city and environment', async () => {
    ...
    const response = await request(app.server).get('/orgs/pets').query({ city: org.city, environment: 'indoor' })
  ...
  it('should be able to search pets by city and all filters', async () => {
    ...
    await Promise.all(
      pets.map((pet) =>
        request(app.server).post('/orgs/pets').set('Authorization', `Bearer ${authResponse.body.token}`).send(pet)
      )
    )
